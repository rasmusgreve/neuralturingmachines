 ...
 */
public class RemoveConnectionMutationOperatorAllTest extends
		RemoveConnectionMutationOperatorTest {

/**
 *  
 */
public RemoveConnectionMutationOperatorAllTest() {
	super();
}
 ...
 * @param aName
 */
public RemoveConnectionMutationOperatorAllTest( String aName ) {
	super( aName );
}
...
protected void initUut() throws Exception {
	uut = new RemoveConnectionMutationOperator( MUTATION_RATE, MAX_WEIGHT_REMOVED,
			RemoveConnectionMutationOperator.Strategy.ALL );
