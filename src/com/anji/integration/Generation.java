...
public class Generation implements XmlPersistable {
	...
	/**
	 * @param aGenotype
	 *            chromosomes from this object make up generation.
	 * @param anId
	 *            of generation
	 */
	public Generation(Genotype aGenotype, long anId, boolean isLastGeneration) {
		genotype = aGenotype;
		id = new Long(anId);
		isLastGen = isLastGeneration;
		cacheXml();
	}
	...
	private void cacheXml() {
		...
		if (!isLastGen)
			return; // hot fix
		System.out.println("Saving final generation...");
