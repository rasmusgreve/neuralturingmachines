 ...
 */
public class LastAffinityListener implements AffinityListener {

	private double lastAffinity = 0;
	 ...
	 * @return max affinity.
	 */
	public synchronized double getLastAffinity() {
		return lastAffinity;
	}
